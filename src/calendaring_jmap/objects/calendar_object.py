...
class JMAPCalendarObject:
    ...
    Attributes:
        ...
        parent: The :class:`~calendaring_jmap.objects.calendar.JMAPCalendar` this object
            belongs to, or ``None`` when fetched without a calendar context
            (e.g. via :meth:`~calendaring_jmap.client.JMAPClient.get_event`).
    """
    ...
    def save(self) -> None:
        ...
        self.parent._bound_client.update_event(
            self.id, ical_str, account_id=self.parent._account_id
        )
